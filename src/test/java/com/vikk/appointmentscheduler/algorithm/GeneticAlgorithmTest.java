...
class GeneticAlgorithmTest {
    ...
    void setUp() {
        ...
        algorithm = new GeneticAlgorithm(appointments, resources);
    }
    ...
    void testAlgorithmInitialization() {
        ...
        assertEquals("Genetic Algorithm", algorithm.getAlgorithmName(), "Algorithm name should be correct");
    ...
    void testOptimizationWithNoResources() {
        GeneticAlgorithm noResourceAlgorithm = new GeneticAlgorithm(appointments, Arrays.asList());
    ...
    void testOptimizationWithNoAppointments() {
        GeneticAlgorithm noAppointmentAlgorithm = new GeneticAlgorithm(Arrays.asList(), resources);
    ...
    void testOptimizationWithConflictingAppointments() {
        ...
        GeneticAlgorithm conflictAlgorithm = new GeneticAlgorithm(conflictingAppointments, resources);
    ...
    void testOptimizationWithFlexibleAppointments() {
        ...
        GeneticAlgorithm flexibleAlgorithm = new GeneticAlgorithm(flexibleAppointments, resources);
    ...
    void testOptimizationWithHighPriorityAppointments() {
        ...
        GeneticAlgorithm urgentAlgorithm = new GeneticAlgorithm(urgentAppointments, resources);
    ...
    void testOptimizationWithResourceCapabilityRequirements() {
        ...
        GeneticAlgorithm specializedAlgorithm = new GeneticAlgorithm(specializedAppointments, resources);
    ...
    void testAlgorithmWithLargeDataset() {
        ...
        GeneticAlgorithm largeAlgorithm = new GeneticAlgorithm(largeAppointments, largeResources);
    ...
    void testAlgorithmWithDifferentAppointmentTypes() {
        ...
        GeneticAlgorithm diverseAlgorithm = new GeneticAlgorithm(diverseAppointments, resources);
